...
test.describe('checkboxes, with conditional reveal', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('/components/checkboxes/with-conditional-reveal')
  })
  ...
  test('hides the email address input when email is deselected', async ({ page }) => {
